<div class="row" id="wifiClientContent">
  <div class="col-lg-12">
    <div class="card">
      ...
      <div class="card-footer"><?php echo _("<strong>Note:</strong> WEP access points appear as 'Open'. AP does not currently support connecting to WEP due to security issues in WEP"); ?></div>
    </div><!-- /.card -->
  </div><!-- /.col-lg-12 -->
</div><!-- /.row -->
