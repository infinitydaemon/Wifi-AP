			...
			<div class="card-body">
				...
				<div id="tabsBandwidth" class="tabcontenttraffic tab-content">
					<div role="tabpanel" class="tab-pane active" id="hourly">
						<div class="row">
							<div class="col-lg-12">
								<h4 class="mt-3"><?php echo _('Hourly Traffic Rate'); ?></h4>
					...
					<div role="tabpanel" class="tab-pane fade" id="daily">
						<div class="row">
							<div class="col-lg-12">
								<h4 class="mt-3"><?php echo _('Daily Traffic Rate'); ?></h4>
					...
					<div role="tabpanel" class="tab-pane fade" id="monthly">
						<div class="row">
							<div class="col-lg-12">
								<h4 class="mt-3"><?php echo _("Monthly Traffic Rate"); ?></h4>
			 ...
			 <div class="card-footer"><?php echo _("https://cwd.systems - https://github.com/infinitydaemon"); ?></div>
     </div><!-- /.card -->
  </div><!-- /.col-lg-12 -->
</div><!-- /.row -->
