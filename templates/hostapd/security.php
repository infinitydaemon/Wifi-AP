<div class="tab-pane fade" id="security">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <figure class="figure">
        <img src="app/img/wifi-qr-code.php" class="figure-img img-fluid" alt="AP Wifi QR code" style="width:100%;">
        <figcaption class="figure-caption"><?php echo _("Scan this QR code with your phone to connect to this device."); ?></figcaption>
      </figure>
    </div>
  </div>
