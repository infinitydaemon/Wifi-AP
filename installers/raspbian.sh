...
-r, --repo, --repository <name>     Overrides the default GitHub repo (AP/raspap-webgui)
...
-i, --insiders                      Installs from the Insiders Edition (AP/raspap-insiders)
...
function _version() {
    _get_release
    echo -e "AP v${RASPAP_RELEASE} - Simple wireless AP setup & management for Debian-based devices"
    exit
}
